    ...
    <div class="container">
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                <h2>Kết quả tìm kiếm của {{$results}}</h2>
            </div>
                ...
                <div class="block2">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <div class="block2-txt-child1 flex-col-l ">
                            <a href="/san-pham/{{ $result->id }}-{{ Str::slug($result->name, '-') }}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                {{ $result->name }}
                            </a>

                            <span class="stext-105 cl3">
                                {!! \App\Helpers\Helper::price($result->price, $result->price_sale) !!}
                            </span>
                        </div>
                    </div>
                </div>
