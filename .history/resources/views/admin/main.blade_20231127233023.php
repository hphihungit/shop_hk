                            ...
                            <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list" aria-labelledby="notificationDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="/template/admin/assets/images/faces/face4.jpg" alt="" class="profile-pic" />
                                    </div>
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="/template/admin/assets/images/faces/face3.jpg" alt="" class="profile-pic" />
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="/template/admin/assets/images/faces/face2.jpg" alt="" class="profile-pic" />
                                    </div>
                                    <div class="preview-item-content">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="flot-chart-wrapper">
                                                <div id="flotChart" class="flot-chart" style="padding: 0px;">
                                                    <canvas class="flot-base" width="1088" height="345" style="width: 870.5px; height: 276px;"></canvas>
                                                    <canvas class="flot-overlay" width="1088" height="345" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 870.5px; height: 276px;"></canvas>
                                                    <div class="flot-svg" style="position: absolute; top: 0px; left: 0px; height: 100%; width: 100%; pointer-events: none;"><svg style="width: 100%; height: 100%;">
                                                            <g class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; inset: 0px;"><text x="0.46249961853027344" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">2000</text><text x="736.3485755678973" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">5500</text><text x="105.58908189701128" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">2500</text><text x="210.7156641754923" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">3000</text><text x="315.8422464539733" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">3500</text><text x="420.9688287324543" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">4000</text><text x="526.0954110109353" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">4500</text><text x="631.2219932894163" y="271.19999980926514" class="flot-tick-label tickLabel" style="position: absolute; text-align: center;">5000</text></g>
                                                        </svg></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/template/admin/assets/images/faces/face10.jpg" alt="image" />
                                                            <div class="table-user-name ml-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/template/admin/assets/images/faces/face11.jpg" alt="image" />
                                                            <div class="table-user-name ml-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/template/admin/assets/images/faces/face13.jpg" alt="image" />
                                                            <div class="table-user-name ml-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/template/admin/assets/images/faces/face16.jpg" alt="image" />
                                                            <div class="table-user-name ml-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-12 col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-md-4">
                                                    <img class="customer-img" src="/template/admin/assets/images/faces/face22.jpg" alt="" />
                                                </div>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="/template/admin/assets/images/faces/face25.jpg" alt="" />
                                                </div>
                                    ...
                                    <div class="row py-1">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="/template/admin/assets/images/faces/face15.jpg" alt="" />
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                    ...
                                    <div class="row py-1">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="/template/admin/assets/images/faces/face5.jpg" alt="" />
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="/template/admin/assets/images/faces/face2.jpg" alt="" />
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                                        <div class="col-sm-9 pl-0">
                                            <div class="d-flex">
                                                <img src="/template/admin/assets/images/dashboard/img_4.jpg" alt="" />
                                                <div class="pl-2">
                                            ...
                                            <p class="text-muted">
                                                ...
                                                <span class="d-inline-block">
                                                    <span class="d-flex d-inline-block">
                                                        <img class="ml-1" src="/template/admin/assets/images/faces/face1.jpg" alt="" />
                                                        <img class="ml-1" src="/template/admin/assets/images/faces/face10.jpg" alt="" />
                                                        <img class="ml-1" src="/template/admin/assets/images/faces/face14.jpg" alt="" />
                                                    </span>
                                                </span>
                                            </p>
                                        </li>
                                    ...
                                    <div class="list-card">
                                        <div class="row align-items-center">
                                            <div class="col-7 col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-sm-4">
                                                        <img src="/template/admin/assets/images/faces/face2.jpg" alt="" />
                                                    </div>
                                    ...
                                    <div class="list-card">
                                        <div class="row align-items-center">
                                            <div class="col-7 col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-sm-4">
                                                        <img src="/template/admin/assets/images/faces/face3.jpg" alt="" />
                                                    </div>
                                                    <div class="col-sm-8 pr-0 pl-sm-0">
                                    ...
                                    <div class="list-card">
                                        <div class="row align-items-center">
                                            <div class="col-7 col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-sm-4">
                                                        <img src="/template/admin/assets/images/faces/face11.jpg" alt="" />
                                                    </div>
                                                    <div class="col-sm-8 pr-0 pl-sm-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="mr-2" src="/template/admin/assets/images/browser-logo/opera-logo.png" alt="" />
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="mr-2" src="/template/admin/assets/images/browser-logo/safari-logo.png" alt="" />
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="mr-2" src="/template/admin/assets/images/browser-logo/chrome-logo.png" alt="" />
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="mr-2" src="/template/admin/assets/images/browser-logo/firefox-logo.png" alt="" />
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <img class="mr-2" src="/template/admin/assets/images/browser-logo/explorer-logo.png" alt="" />
