        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    ...
                    {{-- Sử dụng chỉ mục của banner để lấy menu tương ứng --}}
                    @if(isset($menus[$loop->index]))
                    @php
                    $menu = $menus[$loop->index];
                    @endphp
...
<section class="bg0 p-t-23 p-b-140">
    <div class="container">
        ...
        <div class="flex-c-m flex-w w-full p-t-45" id="button-loadMore">
            ...
            <a onclick="loadMore()" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 pointer">
                Load More
            </a>
        </div>
    </div>
