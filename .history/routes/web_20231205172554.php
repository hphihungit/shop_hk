...
Route::get('auth/facebook', [FacebookController::class, 'redirectToGoogle'])->name('login.facebook');
Route::get('auth/facebook/callback', [FacebookController::class, 'handleGoogleCallback']);
