...
Route::get('auth/facebook', [LinkedinController::class, 'redirectToGoogle'])->name('login.linkedin');
Route::get('auth/facebook/callback', [LinkedinController::class, 'handleGoogleCallback']);
