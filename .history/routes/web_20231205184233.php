...
Route::get('auth/linkedin', [LinkedinController::class, 'redirectToGoogle'])->name('login.linkedin');
Route::get('auth/facebook/linkedin', [LinkedinController::class, 'handleGoogleCallback']);
